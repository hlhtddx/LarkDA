...
from larksuiteoapi.service.drive.v1.api import Service as MediaService
from larksuiteoapi.service.drive_explorer.v2 import FolderRootMetaResult, FolderMetaResult, FolderChildrenResult, \
    FolderCreateResult, FolderCreateReqBody
